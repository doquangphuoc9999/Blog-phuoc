            ...
            <div class="container-fluid">
                <div class="page-add" style="margin: 30px;">
                    <div class="content" style="border: 1px solid; padding: 50px">
                        <h2 style="text-align: center; margin-bottom: 23px">Add Author</h2>
                        <h2 style="text-align: center; margin-bottom: 23px">${mess}</h2>
                        <form action="/addAuthor" method="post">
                            <lable><b>Name Author</b></lable>
                            <input type="text" name="nameAuthor" style="width: 80%; height: 14%; border-radius:5px " placeholder="Enter name author...."> <br>
                            ...
                            <div class="submit" style="margin-top: 20px; display: flex; justify-content: space-between ">
                                ...
                                <div class="back">
                                    <button style="border-radius: 9px; margin-right: 97px; width: 77px; padding: 5px;"><a href="/manageAuthor">Back</a></button>
                                </div>
                            </div>
                        </form>
                    </div>
