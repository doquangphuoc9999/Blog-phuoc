            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            <c:forEach items="${listNewPost}" var="listPost">
                                <li>
                                    <a href="/blogSingle?id=${listPost.idPost}">
                                        <img src="${listPost.image}" alt="Image placeholder" class="mr-4">
                                        <div class="text">
                                            <h4>${listPost.title}</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">${listPost.publisht}</span> &bullet;
            ...
            <div class="col-md-6 ml-auto">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                <c:forEach var="list" items="${randDomList}">
                                    <li>
